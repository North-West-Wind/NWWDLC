...
CREATE TABLE IF NOT EXISTS `dcmc` (
  ...
  PRIMARY KEY (`id`)
) ENGINE = MyISAM AUTO_INCREMENT = 225 DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_bin;
...
CREATE TABLE IF NOT EXISTS `leveling` (
  ...
  PRIMARY KEY (`id`)
) ENGINE = InnoDB AUTO_INCREMENT = 452 DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_bin;
