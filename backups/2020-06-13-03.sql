...
CREATE TABLE IF NOT EXISTS `dcmc` (
  ...
  PRIMARY KEY (`id`)
) ENGINE = MyISAM AUTO_INCREMENT = 241 DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_bin;
...
CREATE TABLE IF NOT EXISTS `leveling` (
  ...
  PRIMARY KEY (`id`)
) ENGINE = InnoDB AUTO_INCREMENT = 588 DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_bin;
